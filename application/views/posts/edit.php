    ...
    <div class="row">
      <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
          ...
          <div class="row">
            <div class="col-sm-6">
              <h5 class="pl-3 pt-4 mb-0"><b>Edit Post</b></h5>
            </div>
          </div>
          </div>
          <div class="card-body">
            <form action="<?php echo base_url('posts/update'); ?>" method="post" enctype="multipart/form-data" class="forms-sample mt-0" id="update_post">
                  ...
                  <div class="row">
                    <div class="image_area">                    
                        <label for="upload_image">
                          <img src="<?php echo base_url('assets/upload/'.$post->image) ?>" id="uploaded_image" class="img-responsive img-circle" />
                          <div class="overlay">
              ...
              <div class="form-group">
                ...
                <input type="text" name="title" class="form-control" id="exampleInputEmail3" value="<?php echo $post->title; ?>" placeholder="Post Title">
                <small class="form-text error"></small>
              </div>
              <div class="form-group">
                <label for="Area">Content</label>
                <textarea name="content" class="form-control" id="exampleTextarea1"><?php echo $post->content; ?></textarea>                
                <small class="form-text error"></small>
              </div>
              <div class="form-group">
